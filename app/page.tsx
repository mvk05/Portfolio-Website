...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Bare-metal firmware for a GPS/IMU wearable pendant on a Tuya T5 E1 MCU. Consumes a cloud-generated TripPlan over WiFi at the trailhead, then runs fully offline and provides trip-safety logic, onboard AMOLED display, geofencing. 3D-printed enclosure designed in Fusion 360. Submitted to HackStorm 2.0 (AIoT track).',
  ...
  },
  {
    ...
    description: 'Full ROS 2 Jazzy robotics stack on a Jetson Orin Nano deployed on a physical RC car. Custom node converts velocity commands into PWM signals via PCA9685 over I2C. OpenCV + cv_bridge pipeline handles real-time obstacle detection.',
